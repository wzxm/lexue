...
- 云函数鉴权工具在 `shared/auth.js`（`requireOwner` / `requireMember` / `requireEdit`）
...
- Mini program project implementation -> `../miniprogram-development/rule.md`
- Cloud function implementation -> `../cloud-functions/rule.md`
