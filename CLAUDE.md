...
技术栈：Taro 4.x + React + TypeScript + Zustand + Tailwind CSS（weapp-tailwindcss）+ 微信云开发（wx-server-sdk）
...
- weapp-tailwindcss 在 webpack 阶段转换 Tailwind 类名，生产构建可能与常规 web 项目有差异
